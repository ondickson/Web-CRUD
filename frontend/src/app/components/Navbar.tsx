            ...
            <>
              ...
              {open && (
                <div className="account-menu" role="menu">
                  ...
                  <Link href="/account/bookings" className="menu-item" role="menuitem">
                  ...
                  <Link href="/account/saved_properties" className="menu-item" role="menuitem">
                  ...
                  <Link href="/account/account" className="menu-item" role="menuitem">
